      ...
      <el-form :model="DialogForm" label-width="auto" label-position size="medium" :rules="rules" ref="DialogForm" class="dialogform">
        ...
        <el-col :span="8">
          <el-form-item label="是否预约" prop="isBooking">
            ...
            <el-select v-model="DialogForm.isBooking" :disabled="dialogInputDisabled"  style="width: 240px;" clearable>
        ...
        <el-col :span="8">
          <el-form-item label="预约期限" prop="deadline">
            <el-date-picker v-model="DialogForm.deadline" type="datetime" :disabled="dialogInputDisabled"  style="width: 240px;" placeholder="--" clearable></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-container>
              ...
              <el-main>
                ...
                :header-cell-style="{background:'#eef1f6',color:'#606266'}" height="440"
                  ...
                  <el-table-column prop="isBooking" label="是否预约" width="80"></el-table-column>
                  <el-table-column prop="deadline" label="预约期限" width="170"></el-table-column>
                  <el-table-column prop="parkingPlaceId" label="车位号" width="90"></el-table-column>
                  <el-table-column prop="enterTime" label="进场时间" width="200" sortable></el-table-column>
                  <el-table-column prop="leaveTime" label="离场时间" width="200"></el-table-column>
                  <el-table-column prop="parkTime" label="停车时长(h)" width="120"></el-table-column>
                  <el-table-column prop="cost" label="停车费用(元)" width="120"></el-table-column>
  ...
  methods:{
    ...
    getDataList(){
      this.$http.post(
        ...
        console.log("qe:",res.data.data.list);
        ...
        for(let i = 0;i<oblist.length;i++){
          ...
          oblist[i].enterTime = this.handleNullDateTime(oblist[i].enterTime);
    ...
    onSubmit(){
      ...
      console.log(this.DialogForm.deadline)
      if(this.DialogForm.isBooking == '已预约'){
        this.DialogForm.isBooking = 1;
      }
      if(this.DialogForm.isBooking == '未预约'){
    ...
    handleFromNullDateTime(datetime){
      if(datetime == '--'){
        return null;
      }else if(datetime == '1970-01-01 08:00'){
        return null;
      }
      else{
